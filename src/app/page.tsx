...
export default function Login() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 relative bg-white overflow-hidden text-slate-900">
      
      {/* ── Background Decoration ── */}
      <div className="absolute top-[-10%] left-[-10%] w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-blue-50 rounded-full blur-[120px] opacity-60 pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-slate-50 rounded-full blur-[120px] opacity-60 pointer-events-none" />

      {/* ── Verify Modal (Overlay) ── */}
      {step === 'verify' && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/10 backdrop-blur-[2px]">
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl relative animate-fade-up border border-slate-100">
            <button
              onClick={handleCancelVerify}
              className="absolute top-4 right-4 p-2 rounded-full text-slate-400 hover:text-slate-900 hover:bg-slate-50 transition-colors"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="flex items-center justify-center gap-2 bg-slate-50 border border-slate-100 rounded-xl px-4 py-3 mb-6 mx-auto w-fit shadow-inner">
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-3.5 px-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg shadow-blue-100 transition-all disabled:opacity-70"
            >
      ...
      {/* ── Left Column: Pitch ── */}
      <div className="relative z-10 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12 border-r border-slate-100">
        ...
        <div className="space-y-8">
          ...
          <div className="flex gap-4 items-start">
            <div className="w-12 h-12 rounded-2xl bg-blue-600 flex items-center justify-center flex-shrink-0 text-white shadow-sm">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center px-6 py-12 bg-slate-50/30">
        <div className="bg-white rounded-3xl p-10 w-full max-w-md shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-slate-100">
